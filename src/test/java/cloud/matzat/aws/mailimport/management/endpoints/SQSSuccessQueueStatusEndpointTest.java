...
public class SQSSuccessQueueStatusEndpointTest {
    ...
    @Autowired
    private SQSSuccessQueueStatusEndpoint sqsSuccessQueueStatusEndpoint;
    ...
    public void contextLoads() {
        assertThat(sqsSuccessQueueStatusEndpoint).isNotNull();
    }

    @Test
    public void setSqsErrorDlQueueStatusEndpointTest() {
        SQSQueueStatus queueStatus = sqsSuccessQueueStatusEndpoint.getQueueStatus();
